...
//Toute cette classe permet de créer des choiceBox avec plus de personnalisation tel qu'une barre de recherche

public class AutoCompleteBox implements fr.ap.apjavafx.lib.newHandlerEvent {
